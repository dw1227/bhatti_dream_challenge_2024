# name: association_ega_acceleration_pregnancy_complications_team2_cpc.R
#
...
#       
# output:results/FigureS5_cpc.pdf
...
pdf("results/FigureS5_CPC.pdf",height=8,width=10)
