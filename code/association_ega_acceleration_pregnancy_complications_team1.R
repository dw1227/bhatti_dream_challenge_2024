# name: association_ega_acceleration_pregnancy_complications_team1.R
#
...
#       
# output:results/FigureS7_team1.pdf
...
metadata<- read_csv(here("data/prb/sample_metadata.csv")) |> 
  dplyr::select("EN_Main_Index","EN_Smoking","EN_smokingtxt","EN_Drugs","EN_Drug_txt",
                "EN_Pre_Preg_Wtkg","DL_Del_WeightKG","DL_Augmented","DL_Lab_Sp","SD_SGA","NEO_SS_Comments")
...
#### eGA acceleration
df$y <- df$ga_3505704_9615595 - df$Del_GA_Calc
...
pdf("results/FigureS7_team1.pdf",height=8,width=10)
