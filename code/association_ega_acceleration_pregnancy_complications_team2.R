# name: association_ega_acceleration_pregnancy_complications_team2.R
#
...
#       
# output:results/FigureS8_team2.pdf
...
#### eGA acceleration
df$y <- df$ga_3506332_9615596 - df$Del_GA_Calc
...
pdf("results/FigureS8_team2.pdf",height=8,width=10)
