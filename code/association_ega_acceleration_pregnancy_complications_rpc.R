# name: association_ega_acceleration_pregnancy_complications_rpc.R
#
...
#       
# output:results/Figure S6_rpc.pdf
...
pdf("results/FigureS6_rpc.pdf",height=8,width=10)
